  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState2 = React4.useState, useEffect5 = React4.useEffect, useLayoutEffect3 = React4.useLayoutEffect, useDebugValue3 = React4.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef4 = React4.useRef, useEffect5 = React4.useEffect, useMemo4 = React4.useMemo, useDebugValue3 = React4.useDebugValue;
...
function buildSlice(_j) {
  ...
  var actions = __spreadProps2(__spreadValues2(__spreadValues2(__spreadValues2(__spreadValues2(__spreadValues2({}, configSlice.actions), querySlice.actions), subscriptionSlice.actions), internalSubscriptionsSlice.actions), mutationSlice.actions), {
...
function useShallowStableValue(value) {
  var cache = (0, import_react10.useRef)(value);
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && !!window.document && !!window.document.createElement ? import_react8.useLayoutEffect : import_react8.useEffect;
...
function buildHooks(_c) {
  ...
  function usePrefetch(endpointName, defaultOptions) {
    ...
    return (0, import_react8.useCallback)(function(arg, options) {
  ...
  function buildQueryHooks(name) {
    var useQuerySubscription = function(arg, _c2) {
      ...
      var lastRenderHadSubscription = (0, import_react8.useRef)(false);
      var promiseRef = (0, import_react8.useRef)();
    ...
    var useLazyQuerySubscription = function(_c2) {
      ...
      var initiate = api.endpoints[name].initiate;
      var dispatch = useDispatch2();
      var _f = (0, import_react8.useState)(UNINITIALIZED_VALUE), arg = _f[0], setArg = _f[1];
      var promiseRef = (0, import_react8.useRef)();
      var stableSubscriptionOptions = useShallowStableValue({
        refetchOnReconnect,
        refetchOnFocus,
      ...
      var subscriptionOptionsRef = (0, import_react8.useRef)(stableSubscriptionOptions);
      usePossiblyImmediateEffect(function() {
        subscriptionOptionsRef.current = stableSubscriptionOptions;
      }, [stableSubscriptionOptions]);
      var trigger = (0, import_react8.useCallback)(function(arg2, preferCacheValue) {
    ...
    var useQueryState = function(arg, _c2) {
      ...
      var lastValue = (0, import_react8.useRef)();
      var selectDefaultResult = (0, import_react8.useMemo)(function() {
      ...
      var querySelector = (0, import_react8.useMemo)(function() {
    ...
    return {
      ...
      useLazyQuery: function(options) {
        ...
        var info = (0, import_react8.useMemo)(function() {
          return { lastArg: arg };
        }, [arg]);
        return (0, import_react8.useMemo)(function() {
      ...
      useQuery: function(arg, options) {
        ...
        (0, import_react8.useDebugValue)({ data, status, isLoading, isSuccess, isError: isError2, error });
        return (0, import_react8.useMemo)(function() {
  ...
  function buildMutationHook(name) {
    return function(_c2) {
      ...
      var dispatch = useDispatch2();
      var _g = (0, import_react8.useState)(), promise3 = _g[0], setPromise = _g[1];
      (0, import_react8.useEffect)(function() {
        return function() {
      ...
      var triggerMutation = (0, import_react8.useCallback)(function(arg) {
        var promise22 = dispatch(initiate(arg, { fixedCacheKey }));
        setPromise(promise22);
        return promise22;
      }, [dispatch, initiate, fixedCacheKey]);
      var requestId = (promise3 || {}).requestId;
      var mutationSelector = (0, import_react8.useMemo)(function() {
      ...
      var finalState = (0, import_react8.useMemo)(function() {
...
function ApiProvider(props) {
  var store = import_react12.default.useState(function() {
    var _c;
  ...
  return import_react12.default.createElement(Provider_default, {
    store,
